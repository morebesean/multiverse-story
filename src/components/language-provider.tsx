...
const translations: Translations = {
    ...
    ko: {
        ...
        "landing.feature.profile.desc": "현재의 나는 어떤 모습인가요? 당신의 이야기를 들려주세요.",
        "landing.feature.choice": "다른 선택",
        "landing.feature.choice.desc": "인생의 갈림길에서 다른 길을 선택했다면 어땠을까요?",
        "landing.feature.story": "이야기 생성",
        "landing.feature.story.desc": "AI가 실시간으로 새로운 차원의 당신의 삶을 그려냅니다.",
